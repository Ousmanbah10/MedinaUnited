...
const management = [
  { role: "Founder & Chairman",          name: "Michael Nicol",       contact: "+1 305 975 6303", photo: MT + "Michela Nocle.jpg" },
  { role: "Director of Women's Chapter", name: "Dr. Mariama Jaiteh",  contact: "",                photo: MT + "Jaiteh.png" },
  { role: "General Manager",             name: "Sanna Jobarteh",      contact: "+220 389 1423",   photo: MT + "Sanna Jobarteh.jpg" },
  { role: "Technical Director",          name: "Sang Mendy",          contact: "+220 762 2396",   photo: MT + "Sang Mendy.jpg" },
  { role: "Office Manager",              name: "Musa Manneh",         contact: "",                photo: MT + "Musa Manneh.jpg" },
  { role: "Secretary General",           name: "Basiru Njie",         contact: "",                photo: MT + "Basiru Njie.jpg" },
  { role: "Facilities Manager",          name: "Modou Dibba",         contact: "",                photo: GL + "imgi_114_DSC_0787.jpg" },
  { role: "Footballers' Mothers' Pres.", name: "Danise Mendy",        contact: "",                photo: MT + "Danise Mendy.jpg" },
  { role: "Sporting Director",           name: "Max Sanz Casasus",    contact: "Barcelona, Spain",photo: MT + "Max Sanz Casasus.jpg" },
];

const technicalTeam = [
  { role: "Technical Director",    name: "Sang Mendy",    photo: MT + "Sang Mendy.jpg" },
  ...
  { role: "U15 Coach",             name: "Musa Manneh",   photo: MT + "Musa Manneh.jpg" },
    ...
    <>
      ...
      <section className="relative text-white overflow-hidden py-20 md:py-28" style={{ backgroundImage: "radial-gradient(ellipse at top right, #c2410c 0%, #f75a0b 40%, #9a3412 100%)" }}>
        <div className="mx-auto max-w-7xl px-4">
          <span className="inline-block text-white text-xs font-black uppercase tracking-widest px-3 py-1 rounded-full mb-4" style={{ background: "rgba(0,0,0,0.25)" }}>Medina United FA</span>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 grid gap-12 md:grid-cols-2 items-start">
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-[#0588b1]">Who We Are</span>
          ...
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-[#0588b1]">Our Vision</span>
      ...
      <section className="bg-gray-50 border-t border-gray-100">
        <div className="mx-auto max-w-7xl px-4 py-16">
          <div className="text-center mb-10">
            <span className="text-xs font-bold uppercase tracking-widest text-[#0588b1]">Our Goals</span>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
            {aims.map((aim, i) => (
              <div key={i} className="bg-white rounded-2xl border border-gray-100 p-5 flex items-start gap-4">
                <span className="h-8 w-8 rounded-full bg-[#f75a0b] text-white text-xs font-black flex items-center justify-center shrink-0">
                  {i + 1}
                </span>
      ...
      <section className="bg-white border-t border-gray-100">
        <div className="mx-auto max-w-7xl px-4 py-16">
          <div className="text-center mb-10">
            <span className="text-xs font-bold uppercase tracking-widest text-[#0588b1]">Leadership</span>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {management.map((m) => (
              <div key={m.name} className="bg-gray-50 rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition">
                ...
                />
                <div className="p-4">
                  <p className="text-xs font-bold uppercase tracking-widest text-[#0588b1] mb-1">{m.role}</p>
      ...
      <section className="text-white" style={{ background: "#f75a0b" }}>
        <div className="mx-auto max-w-7xl px-4 py-16">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {technicalTeam.map((t) => (
              <div key={`${t.role}-${t.name}`} className="rounded-xl overflow-hidden" style={{ background: "#f75a0b" }}>
                <img
                  src={t.photo}
                  alt={t.name}
      ...
      <section className="bg-gray-50 border-t border-gray-100">
        <div className="mx-auto max-w-7xl px-4 py-16 grid gap-12 md:grid-cols-2">
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-[#0588b1]">Governance</span>
            ...
            <ul className="space-y-2">
              {board.map((name) => (
                <li key={name} className="flex items-center gap-3 text-gray-700 text-sm py-2 border-b border-gray-100 last:border-0">
                  <span className="h-2 w-2 rounded-full bg-[#f75a0b] shrink-0" />
                  {name}
                </li>
              ))}
            </ul>
          ...
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-[#0588b1]">Guidance</span>
      ...
      {/* JOIN CTA */}
      <section style={{ background: "#0588b1" }}>
        <div className="mx-auto max-w-7xl px-4 py-10 flex flex-col sm:flex-row items-center justify-between gap-5">
          ...
          <Link
            to="/join"
            className="shrink-0 rounded-xl px-8 py-3 text-sm font-black text-white transition shadow"
