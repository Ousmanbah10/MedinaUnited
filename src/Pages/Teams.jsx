...
const teams = [
  {
    ...
    desc: "Medina United's Men's First Division side competes at the highest level of domestic club football in The Gambia. 2024 GFF Cup Champions. Built on the foundation of our youth academy, the 1st Division team is the pinnacle of the MUFA pathway — where academy graduates step up and compete professionally.",
    coaches: ["Pierre Gomez (Head Coach)", "Sang Mendy (Technical Director)"],
    highlights: [
      "2024 GFF Cup Champions",
      "GFF Division 1 competitors",
